...
public class StudentRepository {
	...
	public StudentRepository() throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException {
	...
	public boolean findByUserName(String userName) {
		try {
			PreparedStatement prepStatement = dbConnection.prepareStatement("select * from student where userName = ?");
			prepStatement.setString(1, userName);	
